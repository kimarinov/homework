...
//1
$read_query = "SELECT * FROM `meal_types` JOIN national_cuisines ON meal_types.cuisine_id = national_cuisines.cuisine_id WHERE meal_types.date_deleted IS NULL";
...
$num = 1;
	while($row = mysqli_fetch_assoc($result)){
		...
		<tr>
			...
			<td><a href="soft_delete.php?id=<?= $row['meal_type_id'] ?>" class="btn btn-warning">SOFT DELETE</a></td>	
